...
class XfermodeView(context: Context?, attrs: AttributeSet?) : View(context, attrs) {
    ...
    private val squartBitmap = Bitmap.createBitmap(150f.px.toInt(), 150f.px.toInt(), Bitmap.Config.ARGB_8888)
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        canvas.drawBitmap(squartBitmap, 150f.px, 50f.px, paint)
        paint.xfermode = null
